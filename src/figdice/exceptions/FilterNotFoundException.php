...
use \Exception;
/**
 * This exception is raised by the engine when you execute a fig:filter
 * which the program cannot locate.
 * Unlike normal runtime situations such as an argument of invalid type in a
 * Function call, or a missing symbol in the universe, a FilterNotFoundException
...
class FilterNotFoundException extends Exception {
	private $filtername;
	public function __construct($filtername, $filename, $line) {
		parent::__construct('Could not create requested filter: ' . $filtername);
